...
<head>
    ...
    <title>CALI-UniStock Keeper</title>
...
<div class="half">
    ...
    <div class="contents">
        <div class="logo-container">
            <img src="${url.resourcesPath}/logo.png" alt="CALI-UniStock Keeper Logo" class="logo">
        </div>
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-7">
                    <h3>Login to <strong>CALI-UniStock Keeper</strong></h3>
